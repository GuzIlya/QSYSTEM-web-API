...
public class QUser implements IidGetter, Serializable {
     ...
     * Расшифрует.
     *
     * @param parolcheg - зашифрованное слово.
     */
    ...
    public boolean isCorrectPassword(String password) {
        return this.parolcheg.equals(password);
    }

    public void recoverAccess(String access) {
        this.parolcheg = access;
    }
    ...
    public boolean hasService(long serviceId) {
        return planServices.stream().anyMatch(planService -> (serviceId == planService.getService().getId()));
    }
    ...
    public Map<Long, QCustomer> getParallelCustomers() {
    ...
    public static class Shadow implements Serializable {
        ...
        /**
         * Тень предыдущего кастомера.
         *
         * @param oldCostomer старый кастомер. Его тень.
         */
        public Shadow(QCustomer oldCostomer) {
            ...
            this.inputData = oldCostomer.getInputData();
